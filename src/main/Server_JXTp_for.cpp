...
auto Server_JXTp::search(std::vector<std::vector<std::vector<unsigned char>>> join_token01,
                        ...
                        const std::vector<std::vector<unsigned char>>& stoken,
                        const std::vector<std::vector<unsigned char>>& xtoken,
                        const std::vector<unsigned char>& stag1) const
    -> SearchResult {
    ...
    //std::vector<std::vector<std::vector<unsigned char>>> res;
    SearchResult result;
    result.res_range.reserve(join_token01.size()); // 预分配空间
    result.res_stag1.reserve(xtoken.size());     // 预分配空间
