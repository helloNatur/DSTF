...
class QdagSrc3DTestVDatasets : public ::testing::Test {
protected:
    void SetUp() override {
        // 1. 加载真实数据
        //  --- 评测构建阶段 (Setup Phase) ---
        ...
        std::string x = "500000"; // 这里可以调整为不同的数据集规模
...
// <<< 新增的性能测试用例
// =================================================================================
TEST_F(QdagSrc3DTestVDatasets, PerformanceBenchmark) {
    // std::cout << std::fixed << std::setprecision(2);
    // std::cout << "========================================================\n";
